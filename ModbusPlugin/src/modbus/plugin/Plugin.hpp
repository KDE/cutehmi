#ifndef CUTEHMI_MODBUSPLUGIN_SRC_MODBUS_PLUGIN_PLUGIN_HPP
#define CUTEHMI_MODBUSPLUGIN_SRC_MODBUS_PLUGIN_PLUGIN_HPP
...
{
	Q_OBJECT
	Q_PLUGIN_METADATA(IID CUTEHMI_BASE_IPLUGIN_IID FILE "ModbusPlugin.json")
