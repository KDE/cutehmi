#ifndef CUTEHMI_MODBUSLIB_INCLUDE_MODBUS_INTERNAL_RTUCONNECTION_HPP
#define CUTEHMI_MODBUSLIB_INCLUDE_MODBUS_INTERNAL_RTUCONNECTION_HPP
...
//		};
//</workaround>
//<workaround id="ModbusLib-2" target="ModbusLib" cause="ModbusLib-1">
		enum class Mode : int
		{
			RS232 = MODBUS_RTU_RS232
		};
