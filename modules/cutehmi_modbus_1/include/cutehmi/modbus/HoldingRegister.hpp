#ifndef H_MODULES_CUTEHMI_u_MODBUS_u_1_INCLUDE_CUTEHMI_MODBUS_HOLDINGREGISTER_HPP
#define H_MODULES_CUTEHMI_u_MODBUS_u_1_INCLUDE_CUTEHMI_MODBUS_HOLDINGREGISTER_HPP
	...
	public QObject
{
	...
	public:
		 ...
		 */
		explicit HoldingRegister(uint16_t value = 0, QObject * parent = nullptr);
