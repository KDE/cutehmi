#ifndef H_MODULES_CUTEHMI_u_APP_u_1_SRC_CUTEHMI_APP_PLUGIN_PLUGINNODEDATA_HPP
#define H_MODULES_CUTEHMI_u_APP_u_1_SRC_CUTEHMI_APP_PLUGIN_PLUGINNODEDATA_HPP
