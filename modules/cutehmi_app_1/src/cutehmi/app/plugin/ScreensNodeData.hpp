#ifndef H_MODULES_CUTEHMI__APP__1_SRC_CUTEHMI_APP_PLUGIN_SCREENSNODEDATA_HPP
#define H_MODULES_CUTEHMI__APP__1_SRC_CUTEHMI_APP_PLUGIN_SCREENSNODEDATA_HPP
