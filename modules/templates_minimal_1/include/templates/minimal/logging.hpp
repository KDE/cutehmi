#ifndef H_MODULES_TEMPLATES__MINIMAL__1_INCLUDE_TEMPLATES_MINIMAL_LOGGING_HPP	// Edit! Modify include guards.
#define H_MODULES_TEMPLATES__MINIMAL__1_INCLUDE_TEMPLATES_MINIMAL_LOGGING_HPP	// Edit! Modify include guards.
