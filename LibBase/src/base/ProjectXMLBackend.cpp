...
QString ProjectXMLBackend::Error::str() const
{
	switch (code()) {
...
ProjectXMLBackend::ProjectXMLBackend(ProjectModel * model, PluginLoader * pluginLoader):
	m_model(model),
	m_pluginLoader(pluginLoader)
{
}

ProjectXMLBackend::Error ProjectXMLBackend::load(QIODevice & device)
{
...
ProjectXMLBackend::Loader0::Loader0(QXmlStreamReader * xmlReader, ProjectModel::Node * root, PluginLoader * pluginLoader):
	m_xml(xmlReader),
	m_root(root),
	m_pluginLoader(pluginLoader)
{
...
ProjectXMLBackend::Error ProjectXMLBackend::Loader0::parse(int versionMinor)
{
...
ProjectXMLBackend::Error ProjectXMLBackend::Loader0::plcClients()
{
