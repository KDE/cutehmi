#ifndef CUTEHMI_STUPIDPLUGIN_SRC_STUPID_PLUGIN_PLUGIN_HPP
#define CUTEHMI_STUPIDPLUGIN_SRC_STUPID_PLUGIN_PLUGIN_HPP
...
{
	Q_OBJECT
	Q_PLUGIN_METADATA(IID CUTEHMI_BASE_IPLUGIN_IID FILE "StupidPlugin.json")
