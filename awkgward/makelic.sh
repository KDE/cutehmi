...
#
# usage: makelic.sh lic_fle comment file_types IORS find_program
...
$find_program $dir -type f \( $file_types \) -exec sh awkgward/putlic.sh {} $lic_file $comment $lic_qualifier $IORS $find_program \;
set +f
