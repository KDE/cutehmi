...
Item
{
	...
	property bool malfunction: false
	property real warningLow: -Infinity
	property real alertLow: -Infinity
	property real warningHigh: Infinity
	property real alertHigh: Infinity
