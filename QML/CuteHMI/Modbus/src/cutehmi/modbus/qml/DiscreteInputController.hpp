#ifndef CUTEHMI_QML_CUTEHMI_MODBUS_SRC_CUTEHMI_MODBUS_QML_DISCRETEINPUTCONTROLLER_HPP
#define CUTEHMI_QML_CUTEHMI_MODBUS_SRC_CUTEHMI_MODBUS_QML_DISCRETEINPUTCONTROLLER_HPP
