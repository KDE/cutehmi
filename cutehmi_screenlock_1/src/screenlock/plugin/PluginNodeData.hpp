#ifndef CUTEHMI_CUTEHMI__SCREENLOCK__1_SRC_SCREENLOCK_PLUGIN_PLUGINNODEDATA_HPP
#define CUTEHMI_CUTEHMI__SCREENLOCK__1_SRC_SCREENLOCK_PLUGIN_PLUGINNODEDATA_HPP
