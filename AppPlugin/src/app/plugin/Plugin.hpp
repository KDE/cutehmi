#ifndef CUTEHMI_APPPLUGIN_SRC_APP_PLUGIN_PLUGIN_HPP
#define CUTEHMI_APPPLUGIN_SRC_APP_PLUGIN_PLUGIN_HPP
...
{
	Q_OBJECT
	Q_PLUGIN_METADATA(IID CUTEHMI_BASE_IPLUGIN_IID FILE "AppPlugin.json")
