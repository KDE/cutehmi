#ifndef CUTEHMI_LIBWIDGETS_SRC_WIDGETS_ABSTRACTQMLWIDGETWRAPPER_HPP
#define CUTEHMI_LIBWIDGETS_SRC_WIDGETS_ABSTRACTQMLWIDGETWRAPPER_HPP
...
class CUTEHMI_WIDGETS_API AbstractQMLWidgetWrapper:
	public QObject
{
	Q_OBJECT
