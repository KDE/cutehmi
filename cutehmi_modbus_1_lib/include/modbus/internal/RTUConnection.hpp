#ifndef CUTEHMI_CUTEHMI__MODBUS__1__LIB_INCLUDE_MODBUS_INTERNAL_RTUCONNECTION_HPP
#define CUTEHMI_CUTEHMI__MODBUS__1__LIB_INCLUDE_MODBUS_INTERNAL_RTUCONNECTION_HPP
...
//		};
//</workaround>
//<workaround id="cutehmi_modbus_1_lib-2" target="cutehmi_modbus_1_lib" cause="cutehmi_modbus_1_lib-1">
		enum class Mode : int
		{
			RS232 = MODBUS_RTU_RS232
		};
