#ifndef CUTEHMI_CUTEHMI__UTILS__1__LIB_INCLUDE_UTILS_MPTR_HPP
#define CUTEHMI_CUTEHMI__UTILS__1__LIB_INCLUDE_UTILS_MPTR_HPP
...
template <class TL, class DL, class TR, class DR>
bool operator ==(const cutehmi::utils::MPtr<TL, DL> & lhs, const cutehmi::utils::MPtr<TR, DR> & rhs) noexcept
{
	return operator ==(static_cast<const std::unique_ptr<TL, DL> & >(lhs), static_cast<const std::unique_ptr<TR, DR> & >(rhs));
}

template <class TL, class DL>
bool operator ==(const cutehmi::utils::MPtr<TL, DL> & lhs, std::nullptr_t) noexcept
{
	return operator ==(static_cast<const std::unique_ptr<TL, DL> & >(lhs), nullptr);
}

template <class TR, class DR>
bool operator ==(std::nullptr_t, const cutehmi::utils::MPtr<TR, DR> & rhs) noexcept
{
...
template <class TS, class DS>
void swap(cutehmi::utils::MPtr<TS, DS> & x, cutehmi::utils::MPtr<TS, DS> & y) noexcept
{
