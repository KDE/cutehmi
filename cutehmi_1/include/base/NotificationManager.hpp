#ifndef CUTEHMI_CUTEHMI__BASE__1__LIB_INCLUDE_BASE_NOTIFICATIONMANAGER_HPP
#define CUTEHMI_CUTEHMI__BASE__1__LIB_INCLUDE_BASE_NOTIFICATIONMANAGER_HPP
...
class CUTEHMI_BASE_API NotificationManager:
	public QObject
{
	Q_OBJECT

	public:
		Q_PROPERTY(NotificationListModel * model READ model NOTIFY modelChanged)
