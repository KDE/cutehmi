#ifndef H_TOOLS_CUTEHMI__CUTEHMI__1_SRC_VERSION_HPP
#define H_TOOLS_CUTEHMI__CUTEHMI__1_SRC_VERSION_HPP
...
#define CUTEHMI_VIEW_VERSION CUTEHMI_VERSION_BRANCH CUTEHMI_VERSION_DEBUG_QUALIFIER CUTEHMI_VERSION_DEV_QUALIFIER
